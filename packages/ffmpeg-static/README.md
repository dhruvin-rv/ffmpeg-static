...
Supports macOS (64-bit and arm64), Linux (32 and 64-bit, armhf, arm64), Windows (32 and 64-bit). [The ffmpeg version currently used is `7.0`.](https://github.com/dhruvin-rv/ffmpeg-static/releases/tag/b7.0)
...
*Note:* During installation, it will download the appropriate `ffmpeg` binary from the [`b7.0` GitHub release](https://github.com/dhruvin-rv/ffmpeg-static/releases/tag/b7.0). Use and distribution of the binary releases of `ffmpeg` are covered by their respective license.
